...
<a-scene debug="true" background="color:gray;">
    ...
    <a-entity
            messagetext front
            text="font:<?php echo $base_url; ?>/assets/Caveat-Bold-msdf.json; value: Meine Zeitansage;negate:false; align:center; shader:msdf; color:#ff0000; width:0.3;opacity:0.9 ; side:double; wrapPixels:450 ; baseline:bottom"
