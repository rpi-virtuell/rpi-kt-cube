...
<body>
<a-scene debug="true" background="color:transparent;">
    <a-entity light="type:directional; castShadow:true;" position="1 1 5"></a-entity>

    <a-entity
            messagetext front
            text="font:<?php echo $base_url; ?>/assets/PermanentMarker-Regular-msdf.json; value: Klappentext;negate:false; align:center; shader:msdf; color:#fff; width:0.3;opacity:0.5 ; side:double; wrapPixels:450 ; baseline:bottom"
            position="0 1.45 -0.245" scale="1 1 1" rotation="0 0 0"
    ...
    <a-entity
            ...
            position="0.01 1.45 -0.25" scale="1 1 1" rotation="0 0 0"
            animation="property: rotation; to: -10 10 0; dur: 2000; easing: easeInOutQuad; loop: true; dir: alternate"
            material="side:double"
    ...
    >
        ...
        <a-entity
                authortext front
                text="font:<?php echo $base_url; ?>/assets/PermanentMarker-Regular-msdf.json; value: author;negate:false; align:right; shader:msdf; color:#fff; opacity:0.5 ; side:double; wrapPixels:400"
